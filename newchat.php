...
?>		
		...
		<div class="message-input">
			...
			<input type="hidden" name="to_user_id" id="to_user_id" value="<?=$_GET['user_id']?>">
			<input type="hidden" name="from_user_id" id="from_user_id" value="<?=$rows['user_id']?>">
...
$("#loader").show();
$.ajax({
url: "chat_save.php", // Url to which the request is send
